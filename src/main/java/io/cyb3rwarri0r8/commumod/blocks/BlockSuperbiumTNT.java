...
public class BlockSuperbiumTNT extends Block {
    ...
    public BlockSuperbiumTNT()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(EXPLODE_PROP, Boolean.valueOf(false)));
    ...
    public void onBlockAdded(World p_149726_1_, BlockPos blockPos, IBlockState blockState) {
        ...
        if (p_149726_1_.isBlockPowered(blockPos)) {
            this.onBlockDestroyedByPlayer(p_149726_1_, blockPos, blockState.withProperty(EXPLODE_PROP, Boolean.valueOf(true)));
    ...
    public void onNeighborBlockChange(World p_149695_1_, BlockPos blockPos, IBlockState blockState, Block neighborBlock)
    {
        ...
        {
            this.onBlockDestroyedByPlayer(p_149695_1_, blockPos, blockState.withProperty(EXPLODE_PROP, Boolean.valueOf(true)));
