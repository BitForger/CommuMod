...
/*
 * CommuMod-1.7.10 - A Minecraft Modification
 ...
 */
public class ItemMinerEgg extends ItemMonsterPlacer {
    ...
    public ItemMinerEgg(String parEntityToSpawnName, int parPrimaryColor,
